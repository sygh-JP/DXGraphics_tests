================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : MfcD3D11ParticleTest1 プロジェクトの概要
===============================================================================

この MfcD3D11ParticleTest1 アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、MfcD3D11ParticleTest1 アプリケーションを構成する各ファイルの内容の概要が含まれています。

MfcD3D11ParticleTest1.vcxproj
...
MfcD3D11ParticleTest1.vcxproj.filters
...
MfcD3D11ParticleTest1.h
    これはアプリケーションのメイン ヘッダー ファイルです。
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CMfcD3D11ParticleTest1App アプリケーション クラスを宣言します。

MfcD3D11ParticleTest1.cpp
    これはメインのアプリケーション ソース ファイルで、CMfcD3D11ParticleTest1App アプリケーション クラスが含まれています。

MfcD3D11ParticleTest1.rc
...
res\MfcD3D11ParticleTest1.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル MfcD3D11ParticleTest1.rc にインクルードされます。

res\MfcD3D11ParticleTest1.rc2
...
MfcD3D11ParticleTest1Dlg.h, MfcD3D11ParticleTest1Dlg.cpp - ダイアログ
    これらのファイルには、CMfcD3D11ParticleTest1Dlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる MfcD3D11ParticleTest1.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、MfcD3D11ParticleTest1.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

MfcD3D11ParticleTest1.manifest
