================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : MyMfcSimpleD3D12Test1 プロジェクトの概要
===============================================================================

この MyMfcSimpleD3D12Test1 アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、MyMfcSimpleD3D12Test1 アプリケーションを構成する各ファイルの内容の概要が含まれています。

MyMfcSimpleD3D12Test1.vcxproj
...
MyMfcSimpleD3D12Test1.vcxproj.filters
...
MyMfcSimpleD3D12Test1.h
    これはアプリケーションのメイン ヘッダー ファイルです。
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CMyMfcSimpleD3D12Test1App アプリケーション クラスを宣言します。

MyMfcSimpleD3D12Test1.cpp
    これはメインのアプリケーション ソース ファイルで、CMyMfcSimpleD3D12Test1App アプリケーション クラスが含まれています。

MyMfcSimpleD3D12Test1.rc
...
res\MyMfcSimpleD3D12Test1.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル MyMfcSimpleD3D12Test1.rc にインクルードされます。

res\MyMfcSimpleD3D12Test1.rc2
...
MyMfcSimpleD3D12Test1Dlg.h, MyMfcSimpleD3D12Test1Dlg.cpp - ダイアログ
    これらのファイルには、CMyMfcSimpleD3D12Test1Dlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる MyMfcSimpleD3D12Test1.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、MyMfcSimpleD3D12Test1.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

MyMfcSimpleD3D12Test1.manifest
